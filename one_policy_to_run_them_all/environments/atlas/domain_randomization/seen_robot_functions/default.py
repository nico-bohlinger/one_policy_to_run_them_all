class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        foot_size_min=0.109716, foot_size_max=0.117283,
        ...
        joint_armature_min=0.08, joint_armature_max=0.12,
        joint_stiffness_min=0.0, joint_stiffness_max=0.5,
        joint_friction_loss_min=0.8, joint_friction_loss_max=1.2,
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[105, 127],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
        ...
        if stay_at_default_for_asymmatric:
            ...
            self.seen_joint_damping[[6, 7, 8]] = self.default_joint_damping[[6, 7, 8]]  # keep higher damping
            ...
            self.seen_joint_stiffness[[6, 7, 8]] = self.default_joint_stiffness[[6, 7, 8]]  # keep higher stiffness
