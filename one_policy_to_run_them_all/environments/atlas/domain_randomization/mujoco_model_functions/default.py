class DefaultDomainMuJoCoModel:
    def __init__(self, env,
                 ...
                 friction_torsional_ground_min=0.08, friction_torsional_ground_max=0.12,
                 friction_torsional_feet_min=0.08, friction_torsional_feet_max=0.12,
                 friction_rolling_ground_min=0.08, friction_rolling_ground_max=0.12,
                 friction_rolling_feet_min=0.08, friction_rolling_feet_max=0.12,
    ...
    def init(self):
        ...
        self.sampled_friction_torsional_feet = self.env.model.geom_friction[127, 1]
        self.sampled_friction_rolling_ground = self.env.model.geom_friction[0, 2]
        self.sampled_friction_rolling_feet = self.env.model.geom_friction[127, 2]
    ...
    def sample(self):
        ...
        self.env.model.geom_friction[[105, 127]] = [self.sampled_friction_tangential, self.sampled_friction_torsional_feet, self.sampled_friction_rolling_feet]
