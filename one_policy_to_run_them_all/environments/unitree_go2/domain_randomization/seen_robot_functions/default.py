class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        foot_size_min=0.0215, foot_size_max=0.0225,
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[20, 32, 44, 56],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
