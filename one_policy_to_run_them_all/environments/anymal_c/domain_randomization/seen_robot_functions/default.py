class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        foot_size_min=0.0295, foot_size_max=0.0305,
        ...
        joint_damping_min=0.8, joint_damping_max=1.2,
        joint_armature_min=0.0, joint_armature_max=0.02,
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[52, 66, 80, 94],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
