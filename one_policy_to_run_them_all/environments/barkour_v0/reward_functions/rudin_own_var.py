...
class RudinOwnVarReward:
    def __init__(self, env,
                 ...
                 collision_coeff=1e0, base_height_coeff=3e1, nominal_trunk_z=0.267, air_time_coeff=1e-1, air_time_max=0.5, symmetry_air_coeff=0.5):
        self.env = env
    ...
    def reward_and_info(self, info, done):
        ...
        collisions = self.env.check_any_collision_for_all([
            "FR_calf", "FL_calf", "RR_calf", "RL_calf", "FR_thigh_3", "FL_thigh_3", "RR_thigh_3", "RL_thigh_3",
        ])
