class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-0.6, add_trunk_mass_max=0.6,
        add_com_displacement_min=-0.0025, add_com_displacement_max=0.0025,
        foot_size_min=0.0079, foot_size_max=0.008,
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[11, 16, 23, 28],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
