class DefaultDomainMuJoCoModel:
    ...
    def init(self):
        ...
        self.sampled_friction_torsional_feet = self.env.model.geom_friction[28, 1]
        self.sampled_friction_rolling_ground = self.env.model.geom_friction[0, 2]
        self.sampled_friction_rolling_feet = self.env.model.geom_friction[28, 2]
    ...
    def sample(self):
        ...
        self.env.model.geom_friction[[11, 16, 23, 28]] = [self.sampled_friction_tangential, self.sampled_friction_torsional_feet, self.sampled_friction_rolling_feet]
