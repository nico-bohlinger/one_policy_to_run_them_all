class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-0.01, add_trunk_mass_max=0.01,
        add_com_displacement_min=-0.0003, add_com_displacement_max=0.0003,
        foot_size_min=0.009217, foot_size_max=0.009313,
        ...
        joint_damping_min=0.02, joint_damping_max=0.04,
        joint_armature_min=0.0025, joint_armature_max=0.0035,
        joint_stiffness_min=0.0, joint_stiffness_max=0.1,
        joint_friction_loss_min=0.000018, joint_friction_loss_max=0.000022,
        add_p_gain_min=-5.0, add_p_gain_max=5.0,
        add_d_gain_min=-0.15, add_d_gain_max=0.15,  
        add_scaling_factor_min=-0.15, add_scaling_factor_max=0.15,     
    ):
        self.env = env
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[9, 13, 17, 21],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
