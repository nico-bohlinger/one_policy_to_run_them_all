...
class RudinOwnVarReward:
    def __init__(self, env,
                 ...
                 collision_coeff=1e0, base_height_coeff=3e1, nominal_trunk_z=1.031, air_time_coeff=1e-1, air_time_max=0.5, symmetry_air_coeff=0.5):
        self.env = env
    ...
    def reward_and_info(self, info, done):
        ...
        joint_nominal_diff_norm = np.sum(np.square(self.env.data.qpos[7:21] - self.env.domain_randomization_seen_robot_function.seen_joint_nominal_position[:14]))
