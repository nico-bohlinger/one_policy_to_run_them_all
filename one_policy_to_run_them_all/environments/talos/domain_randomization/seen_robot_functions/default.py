...
class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-1.7, add_trunk_mass_max=1.7,
        add_com_displacement_min=-0.0025, add_com_displacement_max=0.0025,
        foot_size_min=0.103, foot_size_max=0.107,
        ...
        add_joint_damping_min=-0.1, add_joint_damping_max=0.1,
        joint_armature_min=0.1, joint_armature_max=0.2,
        joint_stiffness_min=0.0, joint_stiffness_max=0.5,
        add_joint_friction_loss_min=-0.1, add_joint_friction_loss_max=0.1,
        add_p_gain_min=-6.0, add_p_gain_max=6.0,
        add_d_gain_min=-0.2, add_d_gain_max=0.2,  
        add_scaling_factor_min=-0.07, add_scaling_factor_max=0.07,     
    ):
        self.env = env
        ...
        self.add_joint_damping_min = add_joint_damping_min
        self.add_joint_damping_max = add_joint_damping_max
        ...
        self.add_joint_friction_loss_min = add_joint_friction_loss_min
        self.add_joint_friction_loss_max = add_joint_friction_loss_max
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[92, 104],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
        ...
        if stay_at_default_for_asymmatric:
            ...
            self.seen_joint_damping = np.maximum(0, self.default_joint_damping + self.env.np_rng.uniform(self.add_joint_damping_min, self.add_joint_damping_max, size=self.default_joint_damping.shape))
            ...
            self.seen_joint_frictionloss = np.maximum(0, self.default_joint_frictionloss + self.env.np_rng.uniform(self.add_joint_friction_loss_min, self.add_joint_friction_loss_max, size=self.default_joint_frictionloss.shape))
