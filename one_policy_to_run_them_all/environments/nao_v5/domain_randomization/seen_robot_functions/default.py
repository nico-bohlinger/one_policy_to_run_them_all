class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-0.06, add_trunk_mass_max=0.06,
        add_com_displacement_min=-0.0008, add_com_displacement_max=0.0008,
        foot_size_min=0.04144, foot_size_max=0.04244,
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[9, 19],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
