...
class RudinOwnVarReward:
    def __init__(self, env,
                 ...
                 joint_velocity_coeff=0.0, joint_acceleration_coeff=2.5e-5, joint_torque_coeff=2e-2, action_rate_coeff=1e-2,
                 collision_coeff=0.0, base_height_coeff=3e1, nominal_trunk_z=0.026, air_time_coeff=0.0, air_time_max=0.5, symmetry_air_coeff=0.0):
        self.env = env
