class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-0.005, add_trunk_mass_max=0.005,
        ...
        joint_armature_min=0.028, joint_armature_max=0.032,
        joint_stiffness_min=0.0, joint_stiffness_max=0.1,
        joint_friction_loss_min=0.1, joint_friction_loss_max=0.3,
        add_p_gain_min=-1.5, add_p_gain_max=1.5,
        add_d_gain_min=-0.07, add_d_gain_max=0.07,  
        add_scaling_factor_min=-0.02, add_scaling_factor_max=0.02,     
    ):
        self.env = env
