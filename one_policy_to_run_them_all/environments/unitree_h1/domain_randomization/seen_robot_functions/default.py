class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-0.7, add_trunk_mass_max=0.7,
        add_com_displacement_min=-0.0025, add_com_displacement_max=0.0025,
        foot_size_min=0.0135, foot_size_max=0.0145,
        ...
        joint_damping_min=0.9, joint_damping_max=1.1,
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[14, 15, 16, 29, 30, 31],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor * self.foot_size_noise_factor
