class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-0.03, add_trunk_mass_max=0.03,
        add_com_displacement_min=-0.0008, add_com_displacement_max=0.0008,
        foot_size_min=0.0097, foot_size_max=0.0103,
        ...
        joint_damping_min=0.08, joint_damping_max=0.12,
        joint_armature_min=0.008, joint_armature_max=0.012,
        joint_stiffness_min=0.0, joint_stiffness_max=0.1,
        joint_friction_loss_min=0.028, joint_friction_loss_max=0.032,
        add_p_gain_min=-3.0, add_p_gain_max=3.0,
        add_d_gain_min=-0.07, add_d_gain_max=0.07,  
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[24, 34, 44, 54, 64, 74],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
