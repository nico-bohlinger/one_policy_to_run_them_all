class DefaultDomainMuJoCoModel:
    ...
    def init(self):
        ...
        self.sampled_friction_torsional_feet = self.env.model.geom_friction[50, 1]
        self.sampled_friction_rolling_ground = self.env.model.geom_friction[0, 2]
        self.sampled_friction_rolling_feet = self.env.model.geom_friction[50, 2]
    ...
    def sample(self):
        ...
        self.env.model.geom_friction[[37, 50]] = [self.sampled_friction_tangential, self.sampled_friction_torsional_feet, self.sampled_friction_rolling_feet]
