class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-0.13, add_trunk_mass_max=0.13,
        add_com_displacement_min=-0.0008, add_com_displacement_max=0.0008,
        foot_size_min=0.0565, foot_size_max=0.0575,
        ...
        joint_damping_min=0.984, joint_damping_max=1.184,
        joint_armature_min=0.04, joint_armature_max=0.05,
        joint_stiffness_min=0.0, joint_stiffness_max=0.1,
        joint_friction_loss_min=0.026, joint_friction_loss_max=0.034,
        add_p_gain_min=-3.0, add_p_gain_max=3.0,
        add_d_gain_min=-0.1, add_d_gain_max=0.1,  
        add_scaling_factor_min=-0.06, add_scaling_factor_max=0.06,     
    ):
        self.env = env
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[37, 50],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
