class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        foot_size_min=0.0168, foot_size_max=0.018,
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[9, 15, 19, 25],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
