class DefaultDomainSeenRobotFunction:
    def __init__(
        ...
        add_trunk_mass_min=-0.3, add_trunk_mass_max=0.3,
        add_com_displacement_min=-0.002, add_com_displacement_max=0.002,
        foot_size_min=0.040685, foot_size_max=0.042345,
        ...
        joint_damping_min=0.4, joint_damping_max=0.6,
        joint_armature_min=0.008, joint_armature_max=0.012,
        joint_stiffness_min=0.0, joint_stiffness_max=0.3,
        joint_friction_loss_min=0.0, joint_friction_loss_max=0.2,
        add_p_gain_min=-4.5, add_p_gain_max=4.5,
        add_d_gain_min=-0.13, add_d_gain_max=0.13,  
        add_scaling_factor_min=-0.045, add_scaling_factor_max=0.045,     
    ):
        self.env = env
    ...
    def sample(self):
        ...
        self.env.model.geom_size[[14, 29],0] = self.env.np_rng.uniform(self.foot_size_min, self.foot_size_max) * self.foot_size_noise_factor
